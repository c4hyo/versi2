...
<body onload="window.print()">
	<page size="A4">
		<table border="4px solid-black">
			<tr>
				<td style="width: 25%"><center><img src="public/img/undip.png" style="margin-top: 0.2cm;margin-bottom: 0.2cm;"></center></td>
		...
		<div style="margin-top: 1cm">
			...
			<center>
				<table style="margin-top: 1cm;" border="2px solid-black" id="dua">
					<tr id="dua">
